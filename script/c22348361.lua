...
function c22348361.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c22348361.filter,tp,LOCATION_DECK,0,1,nil) end
...
function c22348361.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if g:GetCount()>0 then Duel.SendtoGrave(g,nil,REASON_EFFECT)
	end
end