--
function c71200030.initial_effect(c)
	--pendulum summon
	...
	e1:SetCountLimit(1)
	e1:SetTarget(c71200030.target)
	e1:SetOperation(c71200030.thop)
	c:RegisterEffect(e1)
end
function c71200030.tgfilter(c)
	return c:IsType(TYPE_MONSTER) and  c:IsType(TYPE_PENDULUM) and c:IsType(TYPE_NORMAL) and not c:IsCode(71200030) and c:IsAbleToHand()
end
...
function c71200030.thop(e,tp,eg,ep,ev,re,r,rp)
