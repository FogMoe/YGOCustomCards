...
function c22348267.flipcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local ctg=Duel.GetMatchingGroupCount(c22348267.spfilter,tp,LOCATION_HAND,0,nil,e,tp)
...
function c22348267.fliptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetOperationInfo(0,CATEGORY_SPECIAL_SUMMON,nil,spct,tp,LOCATION_HAND)
...
function c22348267.flipop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,aux.NecroValleyFilter(c22348267.spfilter),tp,LOCATION_HAND,0,spct,spct,nil,e,tp)
